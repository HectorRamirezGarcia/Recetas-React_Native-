...
export default function MyTextInput(props){
    ...
    return (
      <Input
        ...
        containerStyle={{marginBottom:20,borderBottomColor: Colors.ICONCOLOR, borderBottomWidth: 1}}
        ...
        leftIcon={<Icon size={24} color={Colors.ICONCOLOR} 
